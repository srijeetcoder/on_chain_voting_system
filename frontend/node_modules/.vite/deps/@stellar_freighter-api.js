...
var require_index_min = __commonJS({
  "node_modules/@stellar/freighter-api/build/index.min.js"(exports, module) {
    !function(r, e) {
      ...
      var r, e, s = { d: (r2, e2) => {
        for (var t2 in e2)
          s.o(e2, t2) && !s.o(r2, t2) && Object.defineProperty(r2, t2, { enumerable: true, get: e2[t2] });
      ...
      s.r(t), s.d(t, { WatchWalletChanges: () => u, addToken: () => S, default: () => D, getAddress: () => i, getNetwork: () => C, getNetworkDetails: () => O, isAllowed: () => I, isBrowser: () => U, isConnected: () => c, requestAccess: () => w, setAllowed: () => R, signAuthEntry: () => N, signMessage: () => l, signTransaction: () => d }), function(r2) {
      ...
      const n = (r2) => {
        ...
        if (U) {
          ...
          if (!t2) {
            const r3 = await T();
            if (r3.error)
              return { signedMessage: null, signerAddress: "", error: r3.error };
          }
        ...
        if (U) {
          ...
          if (!t2) {
            const r3 = await T();
            if (r3.error)
              return { signedAuthEntry: null, signerAddress: "", error: r3.error };
          }
          const o2 = await (async (r3, s3, t3) => {
            const o3 = (t3 || {}).address;
            let T2;
      ...
      const U = "undefined" != typeof window, D = { getAddress: i, addToken: S, signTransaction: d, signMessage: l, signAuthEntry: N, isConnected: c, getNetwork: C, getNetworkDetails: O, isAllowed: I, setAllowed: R, requestAccess: w, WatchWalletChanges: u };
      return t;
    })());
  }
});
